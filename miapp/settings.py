...
SECRET_KEY = "django-insecure-ej2p3l+7-1-1u3dsy^o1vp82vtt(15)$$0=1&dj71d$#5dwapw"
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "modulos" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
ARCHIVOS_DIR = os.path.join(os.path.expanduser("~"), "Desktop", "documentos")
